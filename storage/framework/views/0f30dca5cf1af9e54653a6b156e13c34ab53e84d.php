...
<link href="<?php echo e(asset('css/status.css')); ?>" rel="stylesheet" type="text/css" />
    ...
    <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
        <div class="portlet light portlet-fit bordered">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject bold status_chart_caption">Current Open UAUC</span>
                </div>
                <div class="count_open_uauc">
                    <span class="count_open">421</span>
                </div>
            </div>
            <div class="portlet-body">
    ...
    <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
        <div class="portlet light portlet-fit bordered">
            <div class="portlet-title">
                ...
                <div class="count_open_uauc">
                    <span class="count_incident">3 </span>
                    <span class="incident_this_year"> In Year 2018</span>
                </div>
            </div>
            <div class="portlet-body">
...
<script src="<?php echo e(asset('js/status.js')); ?>" type="text/javascript"></script>
<?php $__env->stopSection(); ?>
